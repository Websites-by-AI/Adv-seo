      ...
      {comparison && (
        ...
        >
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a
              href="/"
              className="flex shrink-0 items-center gap-2 rounded-xl bg-emerald-500 px-5 py-3 text-xs font-black text-emerald-950 shadow-lg shadow-emerald-500/30 transition hover:bg-emerald-400"
            >
